...
if (args.Length >= 1 && args[0].Equals("markup-list", StringComparison.OrdinalIgnoreCase))
{
...
if (args.Length >= 1 && args[0].Equals("set-diff", StringComparison.OrdinalIgnoreCase))
{
...
if (args.Length >= 1 && args[0].Equals("e2k-takeoff", StringComparison.OrdinalIgnoreCase))
{
