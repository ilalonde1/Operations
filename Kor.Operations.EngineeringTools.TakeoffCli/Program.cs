...
public static class TakeoffCliHelp
{
    ...
    [
        ...
        new("pdf-at", "takeoff pdf-at <pdf> <page> <x> <y> --scale N [--radius mm] [--rules-db <conn>]", "What happened to the ink here: every path and word within a radius of a point (page mm, the frame of pdf-overlay --mark), each with the fate the intake gave it."),
