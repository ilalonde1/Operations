...
public static class TakeoffCliHelp
{
    ...
    [
        ...
        new("dxf-inspect", "takeoff dxf-inspect <plan.dxf> [--walls] [--plates] [--loops] [--faces [--layers A,B]]", "Inspect DXF layers, loops, wall outlines, recovered floor plates; --loops lists loops whose centroid is the vertex mean; --faces the planar faces of the lines and the open chains that keep an edge from closing."),
