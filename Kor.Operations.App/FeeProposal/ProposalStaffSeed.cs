...
namespace Kor.Operations.App.FeeProposal
{
    internal static class ProposalStaffSeed
    {
        public static void EnsureSeeded(IProposalStaffStore store)
        {
            ...
            {
                new() { Id = "6e041b48c8374e14bd46a27c8f6282d9", FullName = "John Markulin",         Credentials = "M.Eng., P.Eng., Struct.Eng., PE, SE",          Title = "" },
                ...
                new() { Id = "b5c8e0f7a9d14f2a3b4c5d6e7f8a9b0c", FullName = "Kevin Wurmlinger",      Credentials = "P.Eng., Struct.Eng., CEng, MIStructE",         Title = "" },
                new() { Id = "c6d9f1a8b0e24f3a4b5c6d7e8f9a0b1d", FullName = "Jim Deroches",          Credentials = "BASc., P.Eng., PE",                            Title = "" },
                new() { Id = "d7e0a2b9c1f34f4a5b6c7d8e9f0a1b2e", FullName = "Rory Beirne",           Credentials = "M.Eng., P.Eng., Struct.Eng., C.Eng., MIStruct", Title = "" },
                new() { Id = "e8f1b3c0d2a44f5a6b7c8d9e0f1a2b3f", FullName = "Mark Bakhtavar",        Credentials = "MASc., P.Eng.",                                Title = "" },
                new() { Id = "f9a2c4d1e3b54f6a7b8c9d0e1f2a3b4a", FullName = "Jason Stuart",          Credentials = "",                                             Title = "Senior Structural Designer" },
            });
        }
    }
}
