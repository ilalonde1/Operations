...
public sealed class CompetitionInfoViewModel : INotifyPropertyChanged
{
    private readonly ICompetitionInfoQueryStore _store;
    private readonly ILogger<CompetitionInfoViewModel> _logger;

    public CompetitionInfoViewModel(
        ICompetitionInfoQueryStore store,
        ILogger<CompetitionInfoViewModel> logger)
    {
        _store = store;
        _logger = logger;
