...
public sealed class PmPerformanceTool
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (OperationCanceledException)
        {
            ...
            return ToolErrorEnvelope.Cancelled("get_pm_performance", (int)sw.ElapsedMilliseconds);
        }
        catch (Exception ex)
        {
            sw.Stop();
            ...
            return ToolErrorEnvelope.FromException("get_pm_performance", ex, (int)sw.ElapsedMilliseconds);
        }
        finally
        {
