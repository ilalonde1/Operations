        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            if (string.IsNullOrWhiteSpace(wbs1))
            {
                ...
                return ToolErrorEnvelope.Validation("get_project_detail", errorMessage, (int)sw.ElapsedMilliseconds);
            }
        ...
        catch (OperationCanceledException)
        {
            ...
            return ToolErrorEnvelope.Cancelled("get_project_detail", (int)sw.ElapsedMilliseconds);
        }
        catch (Exception ex)
        {
            sw.Stop();
            ...
            return ToolErrorEnvelope.FromException("get_project_detail", ex, (int)sw.ElapsedMilliseconds);
        }
        finally
        {
