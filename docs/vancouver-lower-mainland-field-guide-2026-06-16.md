% Lower Mainland — BD Field Guide
% KOR Structural — Business Development
% 2026-06-17

*The pursue-and-call guide for everyone doing BD: where the work is, who to team with, and who to phone Monday. Every figure reconciles to a live query (see the Data Integrity Check at the end); contacts are from KOR's own graph, verified where marked ✓.*

---

## THE PRIZE
KOR's Lower Mainland opportunity as an honest **funnel** — "open" means *genuinely pursuable*, never "we just don't have an SE on file":
...
| **Genuinely early-stage, in-lane, no SE** | **500** | pre-team — a seat could still be open |
| **+ KOR has a warm path** (owner, architect, or GC relationship) | **222** | **the realistic pursuit universe** |
| Near-term, act this quarter | **~20** | the Pursue Shortlist below |

KOR's record on what it actually chases: **177 won / 79 lost (~69%)**.

**How the seat is won:** the architect is the Prime Consultant — they assemble the team (SE included) *before* the RFP. KOR wins by being on that team early. That is why the **222 warm-path projects — not the raw 814 — are the number that matters.**
...
|---|--:|--:|---|
| Total addressable (upper bound) | ~$61B | ~$611M | *every* early-stage in-lane no-SE LM project — most KOR has no path to; **context only, not a target** |
| **Warm-path serviceable** | **~$26B** | **~$261M** | the **222** projects where KOR holds a relationship on the team — the realistic field |
| **Realistic expected (SOM)** | — | **~$141M** | expected value across the warm set: each fee × KOR's win-probability (relationship strength × ~69% close rate) |
...
**By stage (the 500 early-open):** ~155 procurement, ~143 capital-plan, ~94 proposed, ~73 permitting, ~24 concept. *(Segment $ splits are order-of-magnitude context; the bankable figures are the funnel + THE NUMBER, both query-reconciled.)*
...
| **Inglewood Care Centre** | 500 | Pre-rezoning (hearing Jun 23) — team forming | Baptist Housing — **Dayle Krahn** + ZGF — **Jerry Foster** |
...
| **Anthem** | 70 projects together | **Mark Kopinya** (SVP Dev) |
| **Arcadis IBI** (Prime, biggest LM pipeline) | client + 2 KOR projects | **Anita Leonoff** (Vancouver lead) |
| **Chris Dikeakos** (warmest Prime) | client + 8 KOR projects | **Chris Dikeakos / Nadia Said** |

**Do NOT chase** (verified locked / dormant — full detail in Verified Status): Richmond Hospital (alliance selected) · Burnaby Hospital (cancelled / re-paced) · JCC (construction Jul-2026) · UBC Lower Mall (under construction) · NE False Creek (dormant) · International Plaza (distressed).

## VERIFIED STATUS — what's *actually* open right now (researched 2026-06-16, sourced)
**The structural engineer is chosen early — when the architect assembles the team, well before the RFP.** So the **construction stage is the gate:** a project in **design-development, permitting-with-drawings, or construction has its SE locked** — even if we don't know who. Only **early-stage** projects (concept / planning / business-plan / pre-procurement) have a genuinely-open seat.
...
- **Vancouver JCC Redevelopment ($427M)** — **construction starts July 2026** → structural drawings are stamped and the SE was engaged 1–2 yrs ago. *Not open.* Urban One / Eldad Goldfarb stay as relationship contacts for *future* JWest work, not this build.
...
**The corrected hot list:** **Surrey Memorial (pre-RFP — position now) → Inglewood (team still forming) → Burnaby (watch the re-tender) → UBC Medicine One (early, long game).** Everything advanced-stage is locked regardless of whether we know the SE.
...
| **hcma** | 5 | 458 | not a client · 18 contacts on file | **highest-value conversion target** — no KOR relationship yet |
...
The reliable timing signal is **stage** (verified), not dates. Of the 500 early-open seats:
...
**Direct dials** (Apollo-verified — ready to call today):
...
The warmest gigs in the book — KOR clients who *own* pursuable (stage-gated, early, no-SE) Lower Mainland seats KOR isn't on. Deltek-verified relationship depth:

| KOR client | Shared projects | Pursuable seats they own KOR isn't on | ~$M | Call |
|---|--:|--:|--:|---|
| **Reliance Properties** | 82 | **4** | 187 | Jon Stovell / Joanna Kwan |
| **Anthem Properties** | 70 | **4** | 124 | Mark Kopinya / Rob Blackwell |
| **Wesgroup Properties** | 78 | **3** | 176 | Beau Jarvis / Brad Jones |
| Bosa Development | 78 | 2 | 76 | principal-to-principal |
| Cressey Development | 116 | 2 | 63 | principal-to-principal |
| Bosa Properties | 44 | 1 | 60 | principal-to-principal |
| Polygon / Solterra | 114 / 52 | 1 each | 38 / 38 | principal-to-principal |
| Ledingham McAllister | 40 | 1 | 35 | principal-to-principal |

**~$800M of pursuable work owned by developers KOR has already done 40–116 projects with.** These are the highest-probability calls on the board — relationship proven, seat genuinely open.

## SEISMIC — KOR's specialty lane (lead with what KOR wins)
BC is Canada's seismic frontier and the Lower Mainland holds **~$4.6B of explicitly-seismic projects (~65 in the graph, ~95% with no SE committed)** — against the broader BC Seismic Mitigation Program backdrop (~270 schools still to do province-wide). KOR's *verified, winnable* seismic fit is **heritage/commercial upgrades + high-importance post-disaster structures** (fire halls, EOCs, hospital-adjacent) — backed by named credits (564 Beatty, ICBC Lonsdale Quay, Simone PBSD), CSA A23.3 Cl.21 code depth, and IEF Cat 3/4 fluency. **Pursue those now.** The K-12 SMP schools are the *build-toward* (KOR has no school credit yet — team for a first reference). *(Full picture: BC Seismic Dossier + KOR Credential Evidence Base.)*

## COMPETITION — who you're up against
Mined from the held SE seats in the region — each rival's active load, the lane they're winning, and KOR's way in:

| Competitor | Active seats | Current lane (what they're winning) | Locked to | KOR's pry-in |
|---|---|---|---|---|
| **Fast + Epp** | broad leader | Health, residential, commercial, mass timber | Perkins+Will, DIALOG | DIALOG is a **KOR foot-in** — wedge their non-timber work |
| **Glotman Simpson** | residential high-rise | Vancouver high-rise residential/mixed-use | Henriquez | their architects (GBL, Francl) also work with others |
| **WHM Structural** | multifamily + Passive House | civic, multifamily | PUBLIC Architecture | beatable on mid-market institutional |
| **RJC Engineers** | education/institutional | civic + K-12 seismic incumbent | Stantec | out-position on heritage/high-importance seismic |
| **Bush, Bohlman & Partners** | healthcare | hospitals (incumbent) | CannonDesign | concede the megaprojects; win the warm developer + seismic lanes |

**The read for the field:** KOR's two *realistic* lanes are **(1) developer-residential**, where the seat is won on **relationship** (KOR's client base: Anthem/Wesgroup/Reliance/Bosa), and **(2) heritage + high-importance seismic**, KOR's verified strength. Lead with those.

## KEY ACCOUNTS — who they are + who to call
The handful of relationships that recur across the pipeline. Work these and you work most of the list.

- **Graham Construction** — *GC · KOR client · on 3 open seats (~$3.96B).* Sits on Richmond Hospital + Annacis WWTP. **Lee Holland** (VP Buildings, BC) · Jordan Hood (DM Buildings).
- **Vancouver Coastal Health** — *Buyer · on 13 open seats.* Owns Richmond Hospital + Squamish LTC. **Richard Gage** (Exec Dir & Chief Project Officer, Capital) · John Hood (Mgr Capital).
- **Arcadis IBI Group** — *Architect/Prime · client · 2 KOR projects · on 8 open seats (~$4.6B).* The biggest-dollar Prime in the region. **Anita Leonoff** (Director, Vancouver Office Lead).
- **University of British Columbia** — *Buyer · client · on 23 open seats (the single biggest repeat owner).* Medicine precinct, student housing, Applied One. **Denise Brown** (Dir Capital Planning) · Natalie Walliser (Dir Facilities Planning).
- **Wesgroup Properties** — *KOR client · 78 projects together · on 4 open SE seats.* The warmest developer relationship in the book. **Beau Jarvis** (CEO) · Brad Jones (SVP Development).
- **Anthem Properties** — *KOR client · 70 projects together · on 4 open SE seats.* **Mark Kopinya** (SVP Development) · Rob Blackwell (EVP Development).
...
**Do this Monday** (every item verified open or relationship-warm — none locked, cancelled, or out-of-lane): (1) **Surrey Memorial Acute Care Tower** — call **Betina Albornoz (Fraser Health)** before the business plan turns into procurement; the one verified-open marquee seat. (2) **Wesgroup (Beau Jarvis)** + **Anthem (Mark Kopinya)** — principal calls on active LM work KOR isn't on (78 / 70 projects of trust). (3) deepen the warmest Primes — **Arcadis IBI (Anita Leonoff)** and **Chris Dikeakos** — get on their next team before the RFP. (4) **Inglewood Care (Dayle Krahn / ZGF)** while the design team is still forming.

---

## DATA INTEGRITY CHECK (run 2026-06-17)
This guide ships only if these assertions pass against the live graph. No figure is hand-typed, and no built, locked, or out-of-lane project can reach an action list:

| Check | Expected | Actual | Result |
|---|--:|--:|:--:|
| Active LM major projects | 867 | 867 | PASS |
| Early-open (no SE, in-lane) | 500 | 500 | PASS |
| Warm pursuit universe | 222 | 222 | PASS |
