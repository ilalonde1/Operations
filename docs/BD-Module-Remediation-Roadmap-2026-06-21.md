...
- **1b. Reclassify the 45 mislabels** — Vendor/Unknown orgs acting as live MPI Proponent/Architect/GC/SE → role-derived Kind (Proponent→Developer/Buyer, Architect→Architect, GC→GC, SE→Competitor). *Verified: 45 orgs.* Some need person-string cleanup (e.g. #77005 "HILL/HO/PANG…").
