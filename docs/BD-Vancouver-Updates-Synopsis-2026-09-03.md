...
| 19 | Continuum Architecture (Victoria): reach Jeremy Beintema (Partner) and Gregory Eeman (architect) via Ben Smith's intro; the other partner is Wil Wiens | Rory (Jim hands over) | Sept | Do not mention Tony James |
...
9. **Continuum:** whether Ben Smith's second name was Gregory Eeman (Architect AIBC) or someone else. The partners are Beintema and Wiens; Kapuscinski has left; Peter Fair is Denver and is not to be contacted.
