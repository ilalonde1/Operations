...
2. **Perkins&Will:** surnames for **Luciano** (moved there about a year ago) and **Ike** (Rory's contact), and whether the principal JM remembers is **Ryan Bragg**.
...
4. **"Barry Architecture"** (Kelowna): which firm. And whether Conor's **Lauren** is Lauren Macaulay of Arcadis; her title is certain, her being the Kelowna Lauren rests on the brain's record only.
...
10. **Trillium:** Trillium Communities (#54443, Victoria seniors housing) rather than Trillium Projects (#221, a KOR client)? Who is "Sue" there?
...
| BAM (Ben Smith) | unresolved: no company of that name found in Apollo or on the web | Low | not on file |
