...
## 0. START HERE (state as of 2026-09-16 03:30, after steps 47 and 54–90 — 255 of 296 sets build from the PDF alone on run 23 (255 of 279 with a stick file of their own); plates on 63% of storeys; steps 86–89 land after run 23 and are measured by run 24 (launched 04:14))
...
| Against the engineers' own models (51 sets on run 23, `corpus-query summary`) | 58% of our columns within 100 mm of theirs (6,660 of 11,421), 53% of theirs within 100 mm of ours (6,623 of 12,513), pooled; the matched counts did not fall between runs 18 and 21 on any set — where the share fell, the judged population grew (§86) |
