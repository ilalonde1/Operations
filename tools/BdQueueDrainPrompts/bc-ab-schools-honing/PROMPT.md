...
```json
{
  ...
  "items": [{
    ...
    "description": "verified description + SD capital plan context + KOR pursuit framing. [providerName: ProjectBriefHoning] marker is legacy — root _providerName is authoritative.",
...
Tool-call budget: 12-18 per item — schools verify faster than
defense / Indigenous.
