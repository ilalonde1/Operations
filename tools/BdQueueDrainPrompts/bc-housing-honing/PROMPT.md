...
```json
{
  ...
  "items": [{
    ...
    "description": "verified description + BC Housing partnership model + KOR pursuit framing. [providerName: ProjectBriefHoning] marker is legacy — root _providerName is authoritative.",
...
Tool-call budget: 15-22 per item — verification + play depth.
