...
namespace Kor.Operations.EngineeringTools.PdfToSafe
{
    ...
    /// `dxf.pdf.column-max-aspect` yet would be a worse failure than using the default.
    /// </remarks>
        ...
        double AgreementLabelReachMm)
    {
            ...
            IReadOnlyDictionary<string, RuleSetting> settings)
        {
            ...
            return options with
            {
                ...
                ColumnMaxAspect       = settings.ValueOr($"{Prefix}.column-max-aspect", options.ColumnMaxAspect),
